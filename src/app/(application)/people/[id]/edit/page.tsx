...
import { createUser, editUser, getUser } from "../../actions";
...
export default function Page() {
  ...
  useEffect(() => {
    (async function() {
      ...
      setUser(userData[0]);
      setCustomFields(userData[0].additional);
    })();
  }, [id]);
  ...
  async function handleSaveUser() {
    ...
    await editUser(completeUser, id)

    setOpen(true)
    setSnackColor('bg-green-500')
    setSnackMessage('Changes saved successfully')
      ...
      <div className="p-5 w-full">
        ...
        <div className="grid grid-cols-4 gap-5">
              ...
              <div className="p-6">
                <div className="w-full">
                  <div className="flex flex-row-reverse w-full items-center gap-5">
                    <button className="py-2 px-5 bg-blue-500 rounded-md text-white font-semibold" onClick={handleSaveUser}>Save</button>
                    <Link href={`/people/${id}`} >
          ...
          <div>
            <div className="bg-white shadow col-span-3 rounded-[16px]">
              <div className="p-6">
                <CustomFieldsSelector id="people" additional={customFields}  />
              </div>
            </div>
          </div>
        </div>
